  ...
  function Browse() {
    ...
    return (
      ...
      <div className="border-2 w-96 max-h-96 overflow-auto  h-fit  border-yellow-400 bg-slate-800 flex flex-col">
      ...
      <div><div className="border-2 w-96 max-h-96 overflow-auto  h-fit  border-yellow-400 bg-slate-800 flex flex-col">
        <div className="bg-black">{Data[num+ plus -1].title}</div>
        <div className='' >{Data[num+plus -1].description}</div> 
        <div className='bg-black p-3'>{Data[num+plus -1].code}</div>
        </div></div>
      </div>
